...
import { CardData } from '../../models/incident-interface';
...
@Component({
  ...
  standalone: true,
  imports: [TableComponentComponent,LoaderComponentComponent,IncidentCreateFormComponentComponent,CommonModule,SidebarModule, CardComponentComponent, NgClass, NgFor, BarChartComponentComponent, ProgressSpinnerModule, SideNavbarComponentComponent],
